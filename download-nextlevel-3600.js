...
const PRODUCT_DIR = 'E:/Jason Desktop/Iconik Software/Web apps/Iconik-Shirts/images/tshirts/nextlevel-3600/product';
const SWATCH_DIR = 'E:/Jason Desktop/Iconik Software/Web apps/Iconik-Shirts/images/tshirts/nextlevel-3600/swatches';

// Read the raw data
const data = JSON.parse(fs.readFileSync('E:/Jason Desktop/Iconik Software/Web apps/Iconik-Shirts/nextlevel-3600-raw.json', 'utf8'));
...
async function downloadAll() {
  ...
  const outputPath = 'E:/Jason Desktop/Iconik Software/Web apps/Iconik-Shirts/data/nextlevel-3600.json';
  fs.mkdirSync(path.dirname(outputPath), { recursive: true });
  fs.writeFileSync(outputPath, JSON.stringify({
    styleId: "nextlevel-3600",
    styleName: "Next Level 3600",
